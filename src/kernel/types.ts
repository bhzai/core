...
/** Legacy type alias mapping BHZAI to the v0.2 Harness interface. */
export type BHZAI = Harness

/** Legacy type alias mapping BHZAIConversation to the v0.2 HarnessSession interface. */
export type BHZAIConversation = HarnessSession
